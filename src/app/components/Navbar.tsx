...
export default function Navbar({ isAuthenticated, onLogout }: NavbarProps) {
    return (
        ...
        <Link href="/" className="px-3 py-1 rounded-full transition-transform duration-150 hover:scale-105 active:scale-95">
        Home
        </Link>
        
        {isAuthenticated ? (
            <>
            <Link href="/dashboard" className="px-3 py-1 rounded-full transition-transform duration-150 hover:scale-105 active:scale-95">
            Dashboard
            </Link>
            <Button
            size="xs"
            ...
            <>
            <Link href="/login" className="px-3 py-1 rounded-full transition-transform duration-150 hover:scale-105 active:scale-95">
            Login
            </Link>
            <Link href="/register" className="px-3 py-1 rounded-full transition-transform duration-150 hover:scale-105 active:scale-95">
            Register
            </Link>
            </>
        )}
