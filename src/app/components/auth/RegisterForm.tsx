...
export default function RegisterForm({
    ...
    return (
        ...
        <TextInput type="email" label="Email" required withAsterisk {...form.getInputProps("email")} />
        <TextInput type="email" label="Conferma email" required withAsterisk {...form.getInputProps("confermaEmail")} />
