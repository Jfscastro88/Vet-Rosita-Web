...
import classes from "./ServiceDetailModal.module.css";
          ...
          {service ? (
            <div className={classes.shell}>
              <button
                ...
                onClick={onClose}
                aria-label={`Chiudi il dettaglio di ${service.title}`}
              >
              ...
              <div className={classes.layout}>
                ...
                <div className={classes.content}>
                  <div>
                    <Modal.Title className={classes.title}>{service.title}</Modal.Title>
                  ...
                  <div>
                    ...
                    <Text className={classes.sectionText}>{service.importance}</Text>
                  </div>
                  <div>
                    <Title order={3} className={classes.sectionLabel}>
                      Curiosità
                    </Title>
                    <Text className={classes.sectionText}>{service.curiosity}</Text>
                  </div>
                </div>
              </div>
            </div>
